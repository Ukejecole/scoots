...
function active() {
  switch (document.title) {
    case "Scooters - Adventure awaits just a scoot away":
      document.querySelector("#home").classList.add("active");
      break;

    case "Scooters - Make A Reservation":
      document.querySelector("#reservation").classList.add("active");
      break;

    case "Scooters - Contact Us":
      document.querySelector("#contact").classList.add("active");
      break;

    case "Scooters - View Available Rentals":
      document.querySelector("#rentals").classList.add("active");
      break;
  }
}
